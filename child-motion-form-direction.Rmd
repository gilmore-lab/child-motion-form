...
## Add code to summarize participant characteristics

<!-- Look up functions to create a tabular summary in R -->

```{r summarize-participant-demographics, eval=FALSE}
# p <- read.csv("analysis/data/participant-metadata.csv")
# str(p)
# Hint: Look at xtabs()
```
...
```{r analyze-and-plot-main-effects}
...
```{r plot-channel-effects, eval=FALSE}
